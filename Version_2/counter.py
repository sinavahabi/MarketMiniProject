...
class Counter:
    ...
    def bitcoin_run_count(self):
        if True:
            ...
            count_file_btc = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
    ...
    def bitcoin_run_count_reader(self):
        ...
        btc_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
                        "RunCount/RunCountBitcoin/bitcoin_count.txt", 'r')
...
# Now we repeat same structure for other methods.
    ...
    def ethereum_run_count(self):
        if True:
            count_file_eth = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
    ...
    def ethereum_run_count_reader(self):
        eth_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
                        "RunCount/RunCountEthereum/ethereum_count.txt", 'r')
    ...
    def bnb_run_count(self):
        if True:
            count_file_bnb = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
    ...
    def bnb_run_count_reader(self):
        bnb_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
                        "RunCount/RunCountBNB/bnb_count.txt", 'r')
    ...
    def gold_run_count(self):
        if True:
            count_file_gold = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
    ...
    def gold_run_count_reader(self):
        gold_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
                         "RunCount/RunCountGold/gold_count.txt", 'r')
    ...
    def gold_coin_run_count(self):
        if True:
            count_file_gold_coin = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
    ...
    def gold_coin_run_count_reader(self):
        gold_coin_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
                              "RunCount/RunCountGoldCoin/gold_coin_count.txt", 'r')
    ...
    def dollar_run_count(self):
        if True:
            count_file_dollar = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
    ...
    def dollar_run_count_reader(self):
        dollar_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
                           "RunCount/RunCountDollar/dollar_count.txt", 'r')
    ...
    def stock_market_run_count(self):
        if True:
            count_file_stock_market = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
    ...
    def stock_market_run_count_reader(self):
        stock_market_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/"
                                 "RunCount/RunCountStockMarket/stock_market_count.txt", 'r')
