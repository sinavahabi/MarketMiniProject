...
class API:
    ...
    def btc_api(self):
        ...
        self.btc_price = re.sub(r'\$', '', final_result_btc)
    ...
    def eth_api(self):
        ...
        self.eth_price = re.sub(r'\$', '', final_result_eth)
    ...
    def bnb_api(self):
        ...
        self.bnb_price = re.sub(r'\$', '', final_result_bnb)
    ...
    def gold_api(self):
        ...
        self.gold_price = re.sub(r'[^,\d]', '', final_result_gold)
    ...
    def gold_coin_api(self):
        ...
        self.gold_coin_price = re.sub(r'[^,\d]', '', final_result_gold_coin)
    ...
    def dollar_api(self):
        ...
        self.dollar_price = re.sub(r'[^,\d]', '', final_result_dollar)
    ...
    def stock_market_api(self):
        ...
        self.stock_market_amount = re.sub(r'[^0-9.]', '', final_result_market)
