...
class DataBase(API, Counter):
    ...
    def btc_mongo_db(self):
        ...
        price = crypto_currency.insert_one({"name": "Bitcoin", "price": self.btc_price + ' $',
                                            "Run Count": self.run_count_btc, "date": date[:16]})
    ...
    def eth_mongo_db(self):
        ...
        price = crypto_currency.insert_one({"name": "Ethereum", "price": self.eth_price + ' $',
                                            "Run Count": self.run_count_eth, "date": date[:16]})
    ...
    def bnb_mongo_db(self):
        ...
        price = crypto_currency.insert_one({"name": "BNB", "price": self.bnb_price + ' $',
                                            "Run Count": self.run_count_bnb, "date": date[:16]})
    ...
    def gold_mongo_db(self):
        ...
        price = iran_local.insert_one({"name": "18 Karat Gold", "price": self.gold_price + ' Rials',
                                       "Run Count": self.run_count_gold, "date": date[:16]})
    ...
    def gold_coin_mongo_db(self):
        ...
        price = iran_local.insert_one({"name": "Gold Coin", "price": self.gold_coin_price + ' Rials',
                                       "Run Count": self.run_count_gold_coin, "date": date[:16]})
    ...
    def dollar_mongo_db(self):
        ...
        price = iran_local.insert_one({"name": "US Dollar", "price": self.dollar_price + ' Rials',
                                       "Run Count": self.run_count_dollar, "date": date[:16]})
    ...
    def stock_market_mongo_db(self):
        ...
        price = iran_local.insert_one({"name": "Total Index of Iran Stock Exchange",
                                       "amount": self.stock_market_amount + ' Million',
                                       "Run Count": self.run_count_stock_market, "date": date[:16]})
