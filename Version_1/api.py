from MarketsMiniProject.RunCount.RunCountBitcoin.main import bitcoin_run_count
from MarketsMiniProject.RunCount.RunCountEthereum.main import ethereum_run_count
from MarketsMiniProject.RunCount.RunCountBNB.main import bnb_run_count
from MarketsMiniProject.RunCount.RunCountGold.main import gold_run_count
from MarketsMiniProject.RunCount.RunCountGoldCoin.main import gold_coin_run_count
from MarketsMiniProject.RunCount.RunCountDollar.main import dollar_run_count
from MarketsMiniProject.RunCount.RunCountStockMarket.main import stock_market_run_count
...
def btc_func():
    ...
    btc_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/RunCount/RunCountBitcoin"
                    "/bitcoin_count.txt", 'r')
...
def eth_func():
    ...
    ethereum_run_count()
    # By reading count from txt file we can insert it to DataBase.
    eth_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/RunCount/RunCountEthereum"
...
def bnb_func():
    ...
    bnb_run_count()
    # By reading count from txt file we can insert it to DataBase.
    bnb_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/RunCount/RunCountBNB"
                    "/bnb_count.txt", 'r')
...
def gold_func():
    ...
    gold_run_count()
    # By reading count from txt file we can insert it to DataBase.
    gold_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/RunCount/RunCountGold"
                     "/gold_count.txt", 'r')
...
def gold_coin_func():
    ...
    gold_coin_run_count()
    # By reading count from txt file we can insert it to DataBase.
    gold_coin_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/RunCount/RunCountGoldCoin"
...
def us_dollar_func():
    ...
    dollar_run_count()
    # By reading count from txt file we can insert it to DataBase.
    dollar_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/RunCount/RunCountDollar"
                       "/dollar_count.txt", 'r')
...
def stock_market_func():
    ...
    # By reading count from txt file we can insert it to DataBase.
    stock_market_file = open("C:/Users/Sazgar/PycharmProjects/pythonProject/MarketsMiniProject/RunCount"
